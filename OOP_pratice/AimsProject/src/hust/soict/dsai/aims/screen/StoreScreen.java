...
public class StoreScreen extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        store.addMedia(new DigitalVideoDisc("Avengers", "Action", "Joss Whedon", 143, 29.99f));
        store.addMedia(new Book("Clean Code", "Technology", 35.0f));
        store.addMedia(new DigitalVideoDisc("Interstellar", "Sci-Fi", "Christopher Nolan", 169, 25.0f));
        store.addMedia(new DigitalVideoDisc("The Dark Knight", "Action", "Christopher Nolan", 152, 22.0f));
